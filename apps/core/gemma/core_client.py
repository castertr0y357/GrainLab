...
def assemble_system_prompt(
    ...
    response_schema_example: str = None,
...
def call_gemma_api(system_prompt: str, user_prompt: str, expected_keys: list = None) -> dict | None:
    ...
    payload = {
        "model": model,
        "messages": [{"role": "system", "content": system_prompt}, {"role": "user", "content": normalized_user_prompt}],
        "temperature": 0.7,
...
ENGINE_FLAVORS = {
    "alkaline-bath": {
        1: [
            {
                "name": "Classic Salted Pretzel/Bagel",
                "desc": "A baseline standard profile featuring traditional crust browning and coarse sea salt finish.",
            },
            {
                "name": "Cinnamon Raisin Swirl",
                "desc": "A sweet-spiced profile with sweet raisin inclusions throughout a dense, chewy crumb.",
            },
            {
                "name": "Sesame Seed Crunch",
                "desc": "A nutty, toasted sesame seed coated crust pairing with a soft, low-hydration crumb.",
            },
            {
                "name": "Garlic Parmesan Glaze",
                "desc": "A savory garlic infused dough with a crispy, parmesan-crusted outer shell.",
            },
            {"name": "Honey Whole Wheat", "desc": "A mellow honey-sweetened bagel/pretzel base with high chewiness."},
        ],
        2: [
            {
                "name": "Jalapeno White Cheddar",
                "desc": "An advanced variation with spicy jalapeno slices and pockets of melted aged white cheddar.",
            },
            {
                "name": "Malted Caramel Onion",
                "desc": "A modern savory profile featuring slow-caramelized sweet onion folding and malt glaze.",
            },
            {
                "name": "Everything Bagel Herb",
                "desc": "An aromatic toasted garlic, onion, poppy seed, and herb crusted variation.",
            },
            {
                "name": "Asiago Rosemary Crust",
                "desc": "An advanced formulation utilizing fresh rosemary infusion and baked asiago topping.",
            },
            {
                "name": "Sweet Maple Pecan Glaze",
                "desc": "A sweet, dessert-inspired bagel/pretzel with maple syrup infusion and toasted pecans.",
            },
        ],
    },
    "cakes-batters": {
        1: [
            {
                ...
                "desc": "A classic vanilla bean sponge with a light, airy crumb structure and high moisture retention.",
            },
            {
                "name": "Double Chocolate Chip Muffins",
                "desc": "A rich dark chocolate batter loaded with chocolate chunks for rich meltability.",
            },
            {
                "name": "Blueberry Lemon Zest Muffins",
                "desc": "A bright lemon-perfumed muffin base bursting with sweet whole blueberries.",
            },
            {
                "name": "Spiced Carrot Walnut Cake",
                "desc": "A traditional spiced batter containing grated carrots and toasted walnuts for texture.",
            },
            {
                "name": "Classic Golden Butter Cake",
                "desc": "A rich, tender butter cake with fine crumb and excellent structure.",
            },
        ],
        2: [
            {
                "name": "Toasted Coconut Lime Cream Cake",
                "desc": "An advanced cake featuring fresh lime zest and coconut cream emulsions.",
            },
            {
                "name": "Salted Caramel Banana Muffin",
                "desc": "A modern profile with caramelized banana paste and salted toffee swirl inserts.",
            },
            {
                "name": "Red Velvet Espresso Infusion",
                "desc": "A sophisticated cocoa-red velvet cake elevated by espresso micro-crystals.",
            },
            {
                "name": "Cardamom Pistachio Sponge",
                "desc": "An advanced delicate cake scented with ground cardamom and layered with toasted pistachios.",
            },
            {
                "name": "Lavender Honey Poppyseed Cake",
                "desc": "A modern floral cake sweetened with lavender-infused honey and poppyseeds.",
            },
        ],
    },
    "choux-paste": {
        1: [
            {
                "name": "Vanilla Bean Cream Puffs",
                "desc": "A traditional hollow choux shell filled with rich vanilla bean pastry cream.",
            },
            {
                "name": "Classic Chocolate Glazed Eclairs",
                "desc": "Standard elongated choux shells topped with a glossy dark chocolate ganache.",
            },
            {
                "name": "Salted Caramel Profiteroles",
                "desc": "Bite-sized choux puffs drizzled with warm, salty caramel glaze.",
            },
            {
                "name": "Espresso Mocha Cream Puffs",
                "desc": "Standard puffs filled with mocha coffee-infused light custard cream.",
            },
            {
                "name": "Lemon Curd Choux Puffs",
                "desc": "Traditional crisp choux filled with a tart, vibrant lemon curd.",
            },
        ],
        2: [
            {
                "name": "Pistachio Praline Eclairs",
                "desc": "Advanced choux pastry filled with toasted pistachio praline paste and pastry cream.",
            },
            {
                "name": "Hazelnut Gianduja Cream Puffs",
                "desc": "A modern variant filled with hazelnut-chocolate gianduja mousse.",
            },
            {
                "name": "Raspberry Rose Chantilly Puff",
                "desc": "An advanced floral choux containing fresh raspberry compote and rosewater cream.",
            },
            {
                "name": "Spiced Cardamom Pear Choux",
                "desc": "A modern choux pastry featuring poached pear cubes and cardamom cream.",
            },
            {
                "name": "Dark Chocolate Grand Marnier Eclair",
                "desc": "Advanced orange-liqueur infused pastry cream in a dark chocolate shell.",
            },
        ],
    },
    "cookies-shortbread": {
        1: [
            {
                ...
                "desc": "A baseline standard cookie prioritizing chocolate chips, balanced horizontal spread, and brown sugar chew.",
            },
            {
                "name": "Golden Sugar Cookie",
                "desc": "Standard soft-baked cookie with a balanced white sugar ratio for crisp edges and chewy centers.",
            },
            {
                "name": "Traditional Oatmeal Raisin",
                "desc": "Reliable rolled oats base bound by butter and eggs, generating a chewy, fibrous structure.",
            },
            {
                "name": "Spiced Ginger Snaps",
                "desc": "Standard molasses-sweetened cookie with high crispness and regular surface cracks.",
            },
            {
                "name": "Old-Fashioned Peanut Butter",
                "desc": "A dense, rich drop cookie using peanut paste fats to shorten gluten strands.",
            },
        ],
        2: [
            {
                "name": "Triple-Valrhona Malted Cookie",
                "desc": "Advanced recipe utilizing malted milk powder and three chocolate chunk inclusions.",
            },
            {
                "name": "Lactic-Fermented Buttermilk Cookie",
                "desc": "Modern profile incorporating buttermilk powder for a faint lactic tang and tender center.",
            },
            {
                "name": "Espresso-Infused Brown Butter",
                "desc": "Advanced cookie with espresso micro-crystals dispersed throughout browned butter fat.",
            },
            {
                "name": "Salted Toffee Pecan drop cookie",
                "desc": "Advanced cookie containing homemade toasted pecan brittle and butter toffee shards.",
            },
            {
                "name": "Chilled Honey-Lavender Cookie",
                "desc": "Modern floral cookie sweetened with wildflower honey and infused lavender.",
            },
        ],
    },
    "enriched-soft": {
        1: [
            {
                "name": "Classic Buttery Brioche",
                "desc": "A rich, egg-and-butter enriched dough yielding an ultra-soft, pillowy feather crumb.",
            },
            {
                "name": "Cinnamon Sugar Swirl Buns",
                "desc": "Standard sweet rolls filled with dark brown sugar and aromatic cinnamon paste.",
            },
            {
                "name": "Cardamom Spiced Sweet Bread",
                "desc": "A traditional Scandinavian recipe scented with freshly ground cardamom seed.",
            },
            {
                "name": "Honey Glazed Soft Dinner Rolls",
                "desc": "Baseline dinner rolls with a shiny honey glaze and exceptionally soft interior.",
            },
            {
                "name": "Orange Zest Morning Buns",
                "desc": "Sweet morning buns infused with refreshing orange zest sugar.",
            },
        ],
        2: [
            {
                "name": "Chocolate Hazelnut Babka",
                "desc": "Advanced twisted loaf layered with dark chocolate ganache and hazelnut spread.",
            },
            {
                "name": "Pecan Sticky Buns",
                "desc": "Advanced morning pastry baked in a pool of caramelized butter, honey, and pecans.",
            },
            {
                "name": "Vanilla Bean Glazed Yeasted Donuts",
                "desc": "Modern light yeasted dough, fried and dipped in a real vanilla bean glaze.",
            },
            {
                "name": "Maple Pecan Braided Crown",
                "desc": "An advanced braided crown dough filled with pure maple butter and chopped pecans.",
            },
            {
                "name": "Sourdough Enriched Swirl Loaf",
                "desc": "Modern sourdough brioche base utilizing wild yeast acidity to balance butter richness.",
            },
        ],
    },
    "flatbreads-griddles": {
        1: [
            {
                ...
                "desc": "A classic flatbread brushed with garlic-infused ghee and fresh cilantro leaves.",
            },
            {
                "name": "Rosemary Sea Salt Focaccia",
                "desc": "Traditional dimpled olive oil flatbread topped with sea salt flakes and rosemary.",
            },
            {
                "name": "Toasted Sesame Pita Bread",
                "desc": "A baseline pocket pita coated with nutty toasted sesame seeds.",
            },
            {
                "name": "Scallion Green Onion Flatbread",
                "desc": "Standard griddle flatbread layered with green scallions and sesame oil.",
            },
            {
                "name": "Spicy Chili Flakes Roti",
                "desc": "Traditional thin unleavened flatbread seasoned with red chili flakes.",
            },
        ],
        2: [
            {
                "name": "Honey Butter English Crumpets",
                "desc": "Advanced high-hydration griddle bread with characteristic honeycomb internal holes.",
            },
            {
                "name": "Cumin Spiced Garlic Pita",
                "desc": "A modern pocket bread seasoned with roasted cumin and garlic paste.",
            },
            {
                "name": "Smoked Paprika Olive Flatbread",
                "desc": "Advanced flatbread topped with kalamata olives and smoked Spanish paprika.",
            },
            {
                "name": "Blue Cheese Fig Focaccia",
                "desc": "A modern flavor profile featuring sweet fig jam and aged blue cheese crumbs.",
            },
            {
                "name": "Caramelized Shallot Herb Flatbread",
                "desc": "Advanced griddle flatbread topped with slow-cooked sweet shallots.",
            },
        ],
    },
    "fresh-pasta-noodles": {
        1: [
            {
                "name": "Classic Egg Semolina Fettuccine",
                "desc": "Traditional rich golden pasta utilizing whole egg yolks and durum semolina flour.",
            },
            {
                "name": "Spinach Herb Green Tagliatelle",
                "desc": "A vibrant green spinach-puree infused dough with fresh garden herbs.",
            },
            {
                "name": "Roasted Garlic Ravioli Dough",
                "desc": "Standard pasta sheet seasoned with sweet roasted garlic paste.",
            },
            {
                "name": "Cracked Black Pepper Pappardelle",
                "desc": "Egg pasta dough studded with coarse cracked black pepper grains.",
            },
            {
                "name": "Vibrant Tomato Basil Penne",
                "desc": "A red-hued tomato paste and fresh basil infused pasta dough.",
            },
        ],
        2: [
            {
                "name": "Beet Root Pink Lasagna Sheets",
                "desc": "Advanced pasta sheets colored with concentrated sweet beet juice.",
            },
            {
                "name": "Squid Ink Black Linguine",
                "desc": "A modern savory seafood pasta colored and flavored with natural squid ink.",
            },
            {
                "name": "Porcini Mushroom Fettuccine",
                "desc": "Advanced pasta dough incorporating dehydrated wild porcini mushroom powder.",
            },
            {
                "name": "Golden Saffron Capellini",
                "desc": "A premium pasta dough infused with luxury saffron threads and white wine.",
            },
            {
                "name": "Herb-Laminated Silk Handkerchiefs",
                "desc": "Advanced pasta with whole parsley leaves pressed between translucent sheets.",
            },
        ],
    },
    "fried-doughs": {
        1: [
            {
                "name": "Glazed Vanilla Ring Donut",
                "desc": "A baseline standard donut with a light, airy crumb and vanilla sugar glaze.",
            },
            {"name": "Cinnamon Sugar Churros", "desc": "Crispy ridged fried dough coated in sweet cinnamon sugar."},
            {
                "name": "Raspberry Jelly Filled Beignets",
                "desc": "Traditional square puffed donuts filled with seedless raspberry jam.",
            },
            {
                "name": "Chocolate Frosted Sprinkles Donut",
                "desc": "A rich yeasted donut topped with dark chocolate icing.",
            },
            {
                "name": "Powdered Sugar Funnel Cake",
                "desc": "Classic crispy fried batter ribbons dusted with powdered sugar.",
            },
        ],
        2: [
            {
                "name": "Maple Bacon Glazed Fritter",
                "desc": "An advanced yeast donut topped with maple glaze and crispy smoked bacon bits.",
            },
            {
                "name": "Apple Cider Spiced Donut",
                "desc": "A modern cake donut flavored with boiled apple cider reduction and fall spices.",
            },
            {
                "name": "Blueberry Glazed Cruller",
                "desc": "Advanced choux-based fried ring donut with a sweet blueberry glaze.",
            },
            {
                "name": "Meyer Lemon Filled Berliner",
                "desc": "A modern Berliner donut filled with tart Meyer lemon curd.",
            },
            {
                "name": "Cardamom Spiced Beignets",
                "desc": "Advanced beignets flavored with ground cardamom and orange blossom honey.",
            },
        ],
    },
    "lean-crusty": {
        1: [
            {
                ...
                "desc": "A traditional country sourdough boule with an open, airy crumb and blistered crust.",
            },
            {
                "name": "Roasted Garlic Herb Batard",
                "desc": "A baseline lean batard filled with roasted sweet garlic cloves and fresh herbs.",
            },
            {
                "name": "Rosemary Sea Salt French Loaf",
                "desc": "A fragrant, long loaf topped with fresh rosemary and sea salt flakes.",
            },
            {
                "name": "Black Olive Oregano Batard",
                "desc": "Standard Mediterranean loaf filled with sliced kalamata olives and oregano.",
            },
            {
                "name": "Simple Hearth Sourdough Batard",
                "desc": "A traditional, highly reliable sourdough batard prioritizing pure grain expression.",
            },
        ],
        2: [
            {
                "name": "Fig & Walnut Sourdough Boule",
                "desc": "Advanced modern boule combining sweet dried black mission figs and toasted walnuts.",
            },
            {
                "name": "Cranberry Pecan Hearth Loaf",
                "desc": "A modern flavor profile featuring tart dried cranberries and toasted pecans.",
            },
            {
                "name": "Toasted Sesame Crust Sourdough",
                "desc": "An advanced sourdough loaf coated completely in toasted sesame seeds for a nutty crunch.",
            },
            {
                "name": "Beer Batter Sourdough Rye",
                "desc": "A modern dark rye bread utilizing craft stout beer instead of water for hydration.",
            },
            {
                "name": "Multigrain Honey Seeded Loaf",
                "desc": "Advanced lean bread packed with pre-soaked flax, sunflower, and pumpkin seeds.",
            },
        ],
    },
    "pastry-lamination": {
        1: [
            {
                ...
                "desc": "Traditional laminated pastry featuring hundreds of paper-thin buttery layers.",
            },
            {
                "name": "Pain au Chocolat",
                "desc": "A baseline standard laminated roll filled with sweet dark chocolate bars.",
            },
            {
                "name": "Cinnamon Swirl Danish",
                "desc": "Standard laminated danish dough swirled with sweet cinnamon butter fill.",
            },
            {
                "name": "Almond Frangipane Turnover",
                "desc": "Traditional turnover filled with sweet almond frangipane paste.",
            },
            {
                "name": "Raspberry Jam Laminated Twist",
                "desc": "A simple laminated twist filled with red raspberry jam.",
            },
        ],
        2: [
            {
                "name": "Meyer Lemon Cheese Danish",
                "desc": "Advanced laminated danish topped with sweet cream cheese and tart lemon curd.",
            },
            {
                "name": "Cardamom Twist Laminated Danish",
                "desc": "A modern danish flavored with Swedish cardamom sugar and orange glaze.",
            },
            {
                "name": "Maple Pecan Plait Danish",
                "desc": "Advanced braided danish pastry filled with maple syrup butter and toasted pecans.",
            },
            {
                "name": "Vanilla Custard Fruit Danish",
                "desc": "Advanced danish filled with vanilla pastry cream and seasonal fruits.",
            },
            {
                "name": "Apple Chausson Laminated Turnover",
                "desc": "A modern flaky turnover filled with caramelized apple compote.",
            },
        ],
    },
    "quick-breads-scones": {
        1: [
            {
                "name": "Banana Walnut Quick Bread",
                "desc": "A traditional sweet quick bread loaded with ripe mashed bananas and walnuts.",
            },
            {
                "name": "Blueberry Lemon Scones",
                "desc": "Classic flaky scones bursting with blueberries and glazed with fresh lemon juice.",
            },
            {
                "name": "Cranberry Sweet Orange Bread",
                "desc": "Standard quick bread featuring tart dried cranberries and sweet orange zest.",
            },
            {
                "name": "Spiced Pumpkin Scones",
                "desc": "A baseline pumpkin scone flavored with ginger, nutmeg, and cinnamon spices.",
            },
            {
                "name": "Classic Cheddar Chive Scones",
                "desc": "Standard savory scones layered with sharp cheddar cheese and fresh chives.",
            },
        ],
        2: [
            {
                "name": "Zucchini Chocolate Chip Quick Bread",
                "desc": "Advanced quick bread with shredded zucchini for moisture and dark chocolate chips.",
            },
            {
                "name": "Maple Pecan Scones",
                "desc": "Modern scones sweetened with maple syrup and packed with toasted pecans.",
            },
            {
                "name": "Cinnamon Apple Streusel Bread",
                "desc": "Advanced quick bread topped with apple slices and a brown sugar streusel.",
            },
            {
                "name": "Lemon Glazed Poppyseed Bread",
                "desc": "A modern quick bread with blue poppyseeds and a tart lemon icing glaze.",
            },
            {
                "name": "Ginger Molasses Scones",
                "desc": "Advanced spiced scones flavored with dark molasses and candied ginger.",
            },
        ],
    },
}
...
def get_archetype_mechanics(
    engine, active_archetype_id=None, preset_slug=None, active_variation_id=None
) -> tuple[str, dict]:
    ...
    if archetype_data:
        target_mechanics = archetype_data.get(
...
def stream_final_insights(
    ...
    if recipe_data:
        safe_recipe_data = {
            ...
            "Flavor Inclusions": [
                item.get("name", "Inclusion")
                for item in recipe_data.get("inclusions", [])
                + recipe_data.get("flavor_inclusions", [])
                + recipe_data.get("additive_items", [])
            ],
        }
    ...
    logger.info(
        f"[Gemma Client] - AI PROMPT FED TO STREAM_FINAL_INSIGHTS (safe_recipe_data): {json.dumps(safe_recipe_data)}"
    )
