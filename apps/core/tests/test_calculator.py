...
class RecipeRestructuringAndBakingTests(TestCase):
    ...
    def test_advanced_substitutions_oils_and_butters(self):
        ...
        self.assertAlmostEqual(
            recipe_olive_oil["lipid_items"][0]["weight"], recipe_olive_oil["flour_weight"] * 0.10, delta=1
        )
        pass
        ...
        self.assertAlmostEqual(
            recipe_salted_butter["lipid_items"][0]["weight"], recipe_salted_butter["flour_weight"] * 0.10, delta=1
        )
        pass
        ...
        self.assertAlmostEqual(
            recipe_unsalted_butter["lipid_items"][0]["weight"], recipe_unsalted_butter["flour_weight"] * 0.10, delta=1
        )
        pass
