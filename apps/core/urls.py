...
from apps.core.views.calculator.final_recipe import FinalRecipeAIView, FinalRecipeView
...
urlpatterns = [
    ...
    path(
        "recipe-final/<slug:category>/<slug:archetype>/ai/",
        FinalRecipeAIView.as_view(),
        name="calculator_final_recipe_ai",
    ),
    ...
    path("inventory/wheat-berry/edit/", views.EditWheatBerryView.as_view(), name="edit_wheat_berry"),
    path(
        "inventory/wheat-berry/toggle/<uuid:id>/",
        views.ToggleWheatBerryActiveView.as_view(),
        name="toggle_wheat_berry_active",
    ),
    path("inventory/wheat-berry/delete/<uuid:id>/", views.DeleteWheatBerryView.as_view(), name="delete_wheat_berry"),
    path(
        "inventory/wheat-berry/analyze/<uuid:id>/",
        views.AiAnalyzeWheatBerryView.as_view(),
        name="ai_analyze_wheat_berry",
    ),
    path("inventory/equipment/add/", views.AddEquipmentView.as_view(), name="add_equipment"),
    path("inventory/equipment/edit/", views.EditEquipmentView.as_view(), name="edit_equipment"),
    ...
    path(
        "inventory/redo-analyze/<str:item_type>/<uuid:id>/", views.RedoAiAnalysisView.as_view(), name="redo_ai_analysis"
    ),
    ...
    path(
        "generate-creativity-recipes/",
        views.GenerateCreativityRecipesView.as_view(),
        name="generate_creativity_recipes",
    ),
