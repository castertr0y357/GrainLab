...
urlpatterns = [
    ...
    path('ai-batch-insights/', views.ai_batch_insights, name='ai_batch_insights'),
    path('ai-optimize-shares/', views.ai_optimize_shares, name='ai_optimize_shares'),
    ...
    path('ai-recipe-details/', views.ai_recipe_details, name='ai_recipe_details'),
]
