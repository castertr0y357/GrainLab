...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        form_factors_data = [
            ...
            # New sub-engine specific form factors
            {
            ...
            },
            {
                ...
                "slug": "standard-silicon-mat-sheet",
                "is_portioned": True,
                "target_weight": 880.0,
                "unit_weight": 110.0,
                "default_count": 8,
        ...
        presets_data = [
            # Lean & Crusty Presets
            {
                ...
                "form_factor": form_factors["cast-iron-dutch-oven"],
            ...
            },
            {
                ...
                "slug": "baguette",
                "dough_category": categories["lean-crusty"],
                "form_factor": form_factors["open-baking-stone-steel"],
            ...
            },
            {
                ...
                "slug": "challah",
                "dough_category": categories["enriched-soft"],
                "form_factor": form_factors["individual-portion-sheet"],
            ...
            # Alkaline Bath Presets
            {
                ...
                "form_factor": form_factors["perforated-baking-sheet"],
                "hydration_override": 0.52,
                "fat_override": 0.03,
                "sugar_override": 0.02,
                "starter_override": 0.0,
            ...
            # Flatbreads & Griddles Presets
            {
                ...
                "form_factor": form_factors["heavy-cast-iron-skillet"],
                "hydration_override": 0.60,
                "fat_override": 0.05,
                "sugar_override": 0.02,
                "starter_override": 0.0,
            ...
            # Quick Breads Presets
            {
                ...
                "form_factor": form_factors["individual-wedge-sheet"],
                "hydration_override": 0.60,
                "fat_override": 0.12,
                "sugar_override": 0.0,
                "starter_override": 0.0,
            ...
            # Cakes & Batters Presets
            {
                ...
                "form_factor": form_factors["straight-sided-round-tin"],
            ...
            # Pastry & Lamination Presets
            {
                ...
                "form_factor": form_factors["perforated-sheet-air-mat"],
                "hydration_override": 0.55,
                "fat_override": 0.10,
                "sugar_override": 0.05,
                "starter_override": 0.0,
            ...
            # Choux Paste Presets
            {
                ...
                "form_factor": form_factors["extrusion-piping-sheet"],
            ...
            # Cookies & Shortbread Presets
            {
                ...
                "form_factor": form_factors["heavy-aluminum-sheet"],
            ...
            # Fried Doughs Presets
            {
                ...
                "form_factor": form_factors["high-volume-oil-vat"],
            ...
            # Fresh Pasta & Noodles Presets
            {
                ...
                "form_factor": form_factors["mechanical-sheeter"],
